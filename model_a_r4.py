...
class MODEL(object):
    ...
    def run(self):
        ...
        with tf.Session() as sess:
            ...
            # R4 deactivated
            train_sets = read_data(self.opt.train_path, self.word_id_mapping, self.opt.max_sentence_len, is_testing=True)
            dev_sets = read_data(self.opt.dev_path, self.word_id_mapping, self.opt.max_sentence_len, is_testing=True)
